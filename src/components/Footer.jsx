...
<div className="img100">
  <img className='img101' src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png?fit=around|198:42&crop=198:42;*,*" alt="" />
</div>
<div className="loc100">
  <div className="country">
<div className="img200">
  <div className="img201">
  <img className='img201' src="https://cdn.britannica.com/97/1597-004-05816F4E/Flag-India.jpg" alt="" />
  </div>
</div>
...
<div className="final2">
  <div className="phela">
    <h6 className="abt">ABOUT ZOMATO</h6>
    <div className="phela1">
    <a href="https://www.zomato.com/who-we-are" className="abt1">Who We Are</a>
    <a href="https://blog.zomato.com/" className="abt2">Blog</a>
    <a href="https://www.zomato.com/careers" className="abt2">Work With Us</a>
    <a href="https://www.zomato.com/investor-relations" className="abt2">Investor Relations</a>
    <a href="https://www.zomato.com/report-fraud" className="abt2">Report Fraud</a>
    <a href="https://blog.zomato.com/press-kit" className="abt2">Press Kit</a>
    <a href="https://www.zomato.com/contact" className="abt2">Contact Us</a>
    </div>
  </div>
  <div className="doosra">
<h6 className="abt">ZOMAVERSE</h6>
<div className="phela1">
<a href="/" className="abt1">Zomato</a>
    <a href="https://blinkit.com/" className="abt2">Blinkit</a>
    <a href="https://www.feedingindia.org/" className="abt2">Feeding India</a>
    <a href="https://www.hyperpure.com/" className="abt2">Hyperpure</a>
    <a href="https://www.zomato.com/zomaland" className="abt2">Zomaland</a>
    <a href="https://www.weatherunion.com/" className="abt2">Weather Union</a>
</div>
  </div>
<div className="teesra">
  <h6 className="abt">FOR RESTAURANTS</h6>
  <div className="phela1">
  <a href="https://www.zomato.com/partner-with-us" className="abt1">Partner With Us</a>
  <a href="https://play.google.com/store/apps/details?id=com.application.services.partner&hl=en_IN&gl=US" className="abt2">Apps For You</a>
  </div>
</div>
<div className="chautha">
<h6 className="abt">LEARN MORE</h6>
<div className="phela1">
<a href="https://www.zomato.com/policies/privacy/" className="abt1">Privacy</a>
    <a href="https://www.zomato.com/policies/security/" className="abt2">Security</a>
    <a href="https://www.zomato.com/policies/terms-of-service/" className="abt2">Terms</a>
    <a href="https://www.zomato.com/directory" className="abt2">Sitemap</a>
</div>
</div>
<div className="phanchva">
  <h6 className="abt">SOCIAL LINKS</h6>
  <div className="fifth1">
    <a href="https://in.linkedin.com/company/zomato" className="logo400">
    <div className="logo500">
    <i class="sc-rbbb40-1 iFnyeo" size="22" color="#1C1C1C"><svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width="22" height="22" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" class="sc-rbbb40-0 cvuzKA"><path d="M0 10C0 4.5 4.5 0 10 0C15.5 0 20 4.5 20 10C20 15.5 15.5 20 10 20C4.5 20 0 15.5 0 10ZM7.0625 8.375H4.75V15.4375H7.0625V8.375ZM7.25 6.1875C7.25 5.5 6.75 5 5.9375 5C5.125 5 4.5625 5.5 4.5625 6.1875C4.5625 6.875 5.0625 7.4375 5.875 7.4375C6.6875 7.4375 7.25 6.875 7.25 6.1875ZM15.5 11.375C15.5 9.1875 14.3125 8.1875 12.8125 8.1875C11.5625 8.1875 11 8.875 10.6875 9.375V8.375H8.375C8.375 9.0625 8.375 15.4375 8.375 15.4375H10.6875V11.5C10.6875 11.3125 10.6875 11.0625 10.75 10.9375C10.9375 10.5 11.3125 10.0625 11.9375 10.0625C12.75 10.0625 13.125 10.6875 13.125 11.6875V15.4375H15.4375C15.5 15.4375 15.5 11.375 15.5 11.375Z"></path></svg></i>
    </div>
    </a>
    <a href="https://www.instagram.com/zomato/" className="logo400">
    <div className="logo500">
    ...
    <a href="https://twitter.com/zomato" className="logo400">
    <div className="logo500">
    ...
    <a href="https://www.youtube.com/zomato" className="logo400">
    <div className="logo500">
    ...
    <a href="https://www.facebook.com/zomato" className="logo400">
    <div className="logo500">
  ...
  <div className="fifth2"></div>
  <div className="fifth2"></div>
  <div className="fifth3">
    <a href="https://www.zomato.com/mobile" className="logo600">
    <div className="logo601">
      <img src="https://b.zmtcdn.com/data/webuikit/9f0c85a5e33adb783fa0aef667075f9e1556003622.png" alt="" className="logo601" />
    </div>
    </a>
    <div className="fifth2"></div>
    <a href="https://play.google.com/store/apps/details?id=com.application.zomato&hl=en_IN&gl=US" className="logo600">
    <div className="logo601">
      <img src="https://b.zmtcdn.com/data/webuikit/23e930757c3df49840c482a8638bf5c31556001144.png" alt="" className="logo601" />
    </div>
    </a>
  </div>
</div>
</div>
<hr className="logo700" />
<p className="logo800">By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2024 © Zomato™ Ltd. All rights reserved.</p>
      </div>
    </div>
  )
}
