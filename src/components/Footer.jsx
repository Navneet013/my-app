...
<div className="final2">
  <div className="phela">
    ...
    <a href="/" className="abt1">Who We Are</a>
    <a href="/" className="abt2">Blog</a>
    <a href="/" className="abt2">Work With Us</a>
    <a href="/" className="abt2">Investor Relations</a>
    <a href="/" className="abt2">Report Fraud</a>
    <a href="/" className="abt2">Press Kit</a>
    <a href="/" className="abt2">Contact Us</a>
    </div>
  </div>
...
<a href="/" className="abt1">Zomato</a>
    <a href="/" className="abt2">Blinkit</a>
    <a href="/" className="abt2">Feeding India</a>
    <a href="/" className="abt2">Hyperpure</a>
    <a href="/" className="abt2">Zomaland</a>
    <a href="/" className="abt2">Weather Union</a>
</div>
  </div>
<div className="teesra">
  <h6 className="abt">FOR RESTAURANTS</h6>
  <div className="phela1">
  <a href="/" className="abt1">Partner With Us</a>
  <a href="/" className="abt2">Apps For You</a>
  </div>
</div>
<div className="chautha">
<h6 className="abt">LEARN MORE</h6>
<div className="phela1">
<a href="/" className="abt1">Privacy</a>
    <a href="/" className="abt2">Security</a>
    <a href="/" className="abt2">Terms</a>
    <a href="/" className="abt2">Sitemap</a>
</div>
</div>
<div className="phanchva">
  <h6 className="abt">SOCIAL LINKS</h6>
  <div className="fifth1">
    <a href="/" className="logo400">
