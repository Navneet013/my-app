...
<div className='ir'>
  <a href="https://www.zomato.com/investor-relations" className='text'>Investor Relations</a>
</div>
<div className='ar'>
<a href="https://www.zomato.com/partner-with-us" className='text'>Add restaurant</a>
</div>
<div className='login'>
...
<a href="/" className='text'>Sign up</a>
       ...
       <div className='downrow'>
        <ul>
          <li>
          <div className="img1">
          <img src="https://b.zmtcdn.com/web_assets/8313a97515fcb0447d2d77c276532a511583262271.png" alt="" className='photo' />
        </div>
          </li>
          <li>
...
<div className="search">
  <div className='box'>
    ...
    <input type="text" placeholder='Search for resturants, cuisine or a dish' className='write2' />
    </div>
  </div>
  </div>
</div>
